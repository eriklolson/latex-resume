...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	{\faMapMarker} {5535 SE Madison St}\\
	\faIcon{phone} {503.975.1208}\\
	\faIcon{at} {\href{mailto:eriklolson@zohomail.com}{eriklolson@zohomail.com}}\\	
\end{minipage}
\begin{minipage}[t]{0.375\textwidth} % 27.5% of the page width for the second row of icons
	...
	% The first parameter is the FontAwesome icon name, the second is the box size and the third is the text
	% Other icons can be found by referring to fontawesome.pdf (supplied with the template) and using the word after \fa in the command for the icon you want
	\faIcon{linkedin} {\href{https://linkedin.com/in/erik-olson-9b6bb7191}{linkedin.com/in/erik-olson-9b6bb7191}}\\
	\faIcon{github} {\href{https://Github.com/eriklolson}{Github.com/eriklolson}}\\
	\faIcon{bitbucket} {\href{https://bitbucket.org/cobrasolutions/}{bitbucket.org/cobrasolutions}}\\
\end{minipage}
...
\begin{entrylist}
	\entry
		{2021}
		{CS50x Introduction to Computer Science \& Programming}
...
\begin{minipage}[t]{0.45\textwidth}
	 {\faGlobe} {\href{https://slowwinewest.com}{\bfseries slowwinewest.com}} | {2022-present}
		\begin{itemize}
   			\item[]\faIcon{bitbucket} {\href{https://bitbucket.org/cobrasolutions/slow-wine-west}{bitbucket.org/cobrasolutions/slow-wine-west}}
		\end{itemize}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.55\textwidth}
	{\faGlobe} {\href{https://flaskwineshop.com}{\bfseries flaskwineshop.com}} | {2021}
    	\begin{itemize}
        	\item[]\faIcon{github} {\href{https://Github.com/eriklolson/flask-wineshop}{Github.com/eriklolson/flask-wineshop}}
            \item[]\faIcon{github} {\href{https://Github.com/eriklolson/python-wine-scraper}{Github.com/eriklolson/python-wine-scraper}}
            \item[]\faIcon{bitbucket} {\href{https://bitbucket.org/cobrasolutions/terraform}{bitbucket.org/cobrasolutions/terraform}}
        \end{itemize}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\textbf{HTML/CSS/SCSS} - proficient\\
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
