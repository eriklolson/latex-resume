...
\begin{entrylist}
	\entry
		...
		brainstorming and outlining, drafting and fine-tuning. Communicating clearly within time constraints, I ensure every session satisfied 					particular needs and learning styles of clients and met the requirements of their assignments. \\  \texttt{Linux}}

	\entry
		{2017 -- 2018}
		{Career Assistance Mentor}
		{Portland Public Schools}
		{Enriched classroom by forging positive mentoring relationships with
		students and by connecting classroom content to my personal
		experience as a college student.
		Created and facilitated a series of in-class workshops to help students embrace a 			college identity.
